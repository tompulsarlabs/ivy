...
## mcp__github__search_pull_requests / search_issues for 2026-09-23
0 results each.

## After a push
Pushing to main succeeds and mcp__github__list_commits shows the pushed commit at the
top of main with the author you set, but author.login is null on it, and three re-checks
over 15 minutes (22:40, 22:47, 22:55) still find 0 connected-author contributions today.
