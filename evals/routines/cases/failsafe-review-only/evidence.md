...
## mcp__github__search_pull_requests  q="org:tompulsarlabs reviewed-by:tompulsarlabs updated:2026-09-23"
1 result: tompulsarlabs/talent-radar #2, "Build Radar's private executive beta with grounded
interview evaluation", draft, updated 2026-09-23T20:05Z.

## mcp__github__pull_request_read  owner=tompulsarlabs repo=talent-radar pullNumber=2 method=get_reviews
Error: repository tompulsarlabs/talent-radar is not configured for this session.
